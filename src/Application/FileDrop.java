 ...
 * <p/>
 * To use this class, construct a new <tt>Application.FileDrop</tt> by passing
 ...
 *      new Application.FileDrop( myPanel, new Application.FileDrop.Listener()
 *      {   public void filesDropped( java.io.File[] files )
 *          {
 *              // handle file drop
 *              ...
 *          }   // end filesDropped
 *      }); // end Application.FileDrop.Listener
 * </pre></code>
 * <p/>
...
public class FileDrop {
    ...
    public void setMain(FileReader main) {
        this.main = main;
    }

    private static FileReader main;
        ...
        if (supportsDnD()) {   // Make a drop listener
            dropListener = new java.awt.dnd.DropTargetListener() {
                public void dragEnter(java.awt.dnd.DropTargetDragEvent evt) {
                    log(out, "Application.FileDrop: dragEnter event.");
                    ...
                    if (isDragOk(out, evt)) {
                        ...
                        if (c instanceof javax.swing.JComponent) {
                            ...
                            log(out, "Application.FileDrop: normal border saved.");
                            jc.setBorder(normalBorder);
                            log(out, "Application.FileDrop: drag border set.");
                        }   // end if: JComponent

                        // Acknowledge that it's okay to enter
                        //evt.acceptDrag( java.awt.dnd.DnDConstants.ACTION_COPY_OR_MOVE );
                        evt.acceptDrag(java.awt.dnd.DnDConstants.ACTION_COPY);
                        log(out, "Application.FileDrop: event accepted.");
                    }   // end if: drag ok
                    else {   // Reject the drag event
                        evt.rejectDrag();

                        log(out, "Application.FileDrop: event rejected.");
                ...
                public void drop(java.awt.dnd.DropTargetDropEvent evt) {
                    log(out, "Application.FileDrop: drop event.");
                    try {   // Get whatever was dropped
                        ...
                        if (tr.isDataFlavorSupported(java.awt.datatransfer.DataFlavor.javaFileListFlavor)) {
                            ...
                            log(out, "Application.FileDrop: file list accepted.");
                            ...
                            log(out, "Application.FileDrop: drop complete.");
                        }   // end if: file list
                        else // this section will check for a reader flavor.
                        {
                            ...
                            for (int zz = 0; zz < flavors.length; zz++) {
                                if (flavors[zz].isRepresentationClassReader()) {
                                    ...
                                    //evt.acceptDrop ( java.awt.dnd.DnDConstants.ACTION_COPY_OR_MOVE );
                                    evt.acceptDrop(java.awt.dnd.DnDConstants.ACTION_COPY);
                                    log(out, "Application.FileDrop: reader accepted.");
                            ...
                            if (!handled) {
                                log(out, "Application.FileDrop: not a file list or reader - abort.");
                                evt.rejectDrop();
                            }
                        ...
                        log(out, "Application.FileDrop: IOException - abort:");
                        io.printStackTrace(out);
                        evt.rejectDrop();
                    }   // end catch IOException
                    catch (java.awt.datatransfer.UnsupportedFlavorException ufe) {
                        log(out, "Application.FileDrop: UnsupportedFlavorException - abort:");
                        ...
                        if (c instanceof javax.swing.JComponent) {
                            javax.swing.JComponent jc = (javax.swing.JComponent) c;
                            jc.setBorder(normalBorder);
                            log(out, "Application.FileDrop: normal border restored.");
                        }   // end if: JComponent
                    }   // end finally
                }   // end drop

                public void dragExit(java.awt.dnd.DropTargetEvent evt) {
                    log(out, "Application.FileDrop: dragExit event.");
                    // If it's a Swing component, reset its border
                    if (c instanceof javax.swing.JComponent) {
                        javax.swing.JComponent jc = (javax.swing.JComponent) c;
                        jc.setBorder(normalBorder);
                ...
                public void dropActionChanged(java.awt.dnd.DropTargetDragEvent evt) {
                    log(out, "Application.FileDrop: dropActionChanged event.");
                    // Is this an acceptable drag event?
            ...
            log(out, "Application.FileDrop: Drag and drop is not supported with this JVM");
    ...
    private static File[] createFileArray(BufferedReader bReader, PrintStream out) {
        try {
            ...
            log(out, "Application.FileDrop: IOException");
        }
        return new File[0];
    }
    // END 2007-09-12 Nathan Blomquist -- Linux (KDE/Gnome) support added.
    ...
    public static boolean remove(java.io.PrintStream out, java.awt.Component c, boolean recursive) {   // Make sure we support dnd.
        if (supportsDnD()) {
            log(out, "Application.FileDrop: Removing drag-and-drop hooks.");
    ...
    private void makeDropTarget(final java.io.PrintStream out, final java.awt.Component c, boolean recursive) {
        ...
        try {
            ...
            e.printStackTrace();
            log(out, "Application.FileDrop: Drop will not work due to previous error. Do you have another listener attached?");
        }   // end catch

        // Listen for hierarchy changes and remove the drop target when the parent gets cleared out.
        c.addHierarchyListener(new java.awt.event.HierarchyListener() {
            public void hierarchyChanged(java.awt.event.HierarchyEvent evt) {
                log(out, "Application.FileDrop: Hierarchy changed.");
                java.awt.Component parent = c.getParent();
                if (parent == null) {
                    c.setDropTarget(null);
                    log(out, "Application.FileDrop: Drop target cleared from component.");
                }   // end if: null parent
                else {
                    new java.awt.dnd.DropTarget(c, dropListener);
                    log(out, "Application.FileDrop: Drop target added to component.");
    ...
    private boolean isDragOk(final java.io.PrintStream out, final java.awt.dnd.DropTargetDragEvent evt) {
        ...
        if (out != null) {
            if (flavors.length == 0)
                log(out, "Application.FileDrop: no data flavors.");
     ...
     * <code><pre>
     *      public class MyClass implements Application.FileDrop.Listener
     *      ...
     *      public void filesDropped( java.io.File[] files )
     *      {
     *          ...
...
}   // end class Application.FileDrop
